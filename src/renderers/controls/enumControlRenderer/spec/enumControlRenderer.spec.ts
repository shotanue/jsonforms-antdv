...
import * as stories from '@/renderers/controls/enumControlRenderer/stories/enumControlRenderer.stories';
...
describe('Basic', () => {
  ...
  it('renders title as label', () => {
    cy.get('label').should('exist').should('contain.text', 'My Enum');
  });
